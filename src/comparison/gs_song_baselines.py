...
from comparison.feature_group import gs_features, song_features
...
def run(method='GS_feature_set', dataset='GS',
    ...
    feature_names = gs_features if method == 'GS_feature_set' else song_features
...
if __name__ == '__main__':
    run(method='SONG_feature_set', dataset='GS')
    run(method='GS_feature_set', dataset='GS')
    run(method='SONG_feature_set', dataset='SONG')
    run(method='GS_feature_set', dataset='SONG')
